...
public final class listSchedule {
  ...
  public static long schedule() throws Exception{
	...
	if(a.getAttr("ProcessorAlloc")!=null){
	  //It already has a processor allocation!! OH MY..!!  check if
	  //this processor is present in the availableProcessors list
	  //this is possible, because declustering allocates all the
	  //basic clusters to a single processor
	  ...
	  //It is not allocated to any processor Allocate it to the
	  //first free processor 

	  //FIXME: this should be: allocate to the
	  //processor with the minimum cost

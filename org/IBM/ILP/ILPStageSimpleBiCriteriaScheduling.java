 ...
 * IMP: Have to set the mip integrality tolerance to 0 in cplex for the
 * correct solution
 */
package org.IBM.ILP;
...
public class ILPStageSimpleBiCriteriaScheduling implements compilerStage{
	...
	//DEBUG
	// System.out.println("exec_weight ret: "+ret);
	return ret;
    }
    ...
    private static float EXECWEIGHT = 0.5f;
    private static float ENERGYWEIGHT = 0.5f;
